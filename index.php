	...
	<body>
		...
		<div class="col-md-12">
			...
			<div class="col-md-4 logbody" style="">
				<?php
				if(isset($_POST['logAgent']))		//checks if the submit button has been click
				{
				...
				<h4 style="color:red;"><?php echo $login->AgentLogin($username, $password);	}?></h4>
				<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
					...
					<br />
					<input type="submit" name="logAgent" value="Login" class="form-control btn btn-primary" />
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
