<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$fertilizer_quantity_requested=strip_tags($_POST['fertilizer']);
		$amount_paid=strip_tags($_POST['amount_paid']);
		...
		if(empty($amount_paid)){
        	$error = "please enter the amount collected";
        }
        if(empty($fertilizer_quantity_requested)){
        	$error = "please enter the quantity of fertilizer";
        }
...
<div class="container-fluid features" id="section2">
		<?php
			//if (isset($print_status) == true) {
				// die($print_status);
		?>
				<!-- <div class="col-md-12">
					<div class="col-md-5"></div>
					<div class="col-md-2" style="margin-top:50px;">
						<a href="printid.php"><button class="btn btn-primary form-control">Print ID</button></a>
					</div>
					<div class="col-md-5"></div>
				</div> -->
		<?php
					...
					<div class="row">
						<div class="col-md-6">
							<label>Earnings:</label>
								<input type="text" name="earning" value="<?php echo !empty($_POST['earning']) ? $_POST['earning'] : ""; ?>" Placeholder="e.g N500,000" class="form-control">
						</div>
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-6">
							<label>Quantity of Fertilizer:&nbsp;<em style="color:red;" >*</em>&nbsp;</label>
								<input type="text" name="fertilizer" value="<?php echo !empty($_POST['fertilizer']) ? $_POST['fertilizer'] : ""; ?>" Placeholder="e.g 20 bags" class="form-control">
						</div>
						<div class="col-md-6">
							<label>Amount Collected:&nbsp;<em style="color:red;" >*</em>&nbsp;</label>
								<input type="text" name="amount_paid" value="<?php echo !empty($_POST['amount_paid']) ? $_POST['amount_paid'] : ""; ?>" Placeholder="e.g N100,000" class="form-control">
						</div>
					</div>
					<div>
